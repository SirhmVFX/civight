  ...
  return (
    <>
      <section className="w-full h-screen p-8 ">
        ...
        <div className="w-full md:w-3/4 flex flex-col items-center h-full ">
          <div className="flex flex-col items-center justify-between h-full pt-20 text-center ">
            <div className="flex flex-col gap-4">
              <div className="w-[300px] h-[300px] mx-auto ">
                {isImg ? (
                  ...
                  <div className=" border-2  w-full h-full flex items-center justify-center rounded-full border-dashed ">
                    <svg
